...
#include <numbers>
    ...
    Vector3&
    operator+=(Vector3& lhv, const Vector3& rhv) {
	lhv.x += rhv.x;
	lhv.y += rhv.y;
	lhv.z += rhv.z;
...
Matrix4x4 MakeAffineMatrix(const Vector3& scale, const Vector3& rot, const Vector3& translate) {
	...
	Matrix4x4 RotateMatY = {
	    ...
	    cosf(rot.y), 0 - sinf(rot.y), 0, 0, 1, 0, 0, sinf(rot.y), 0, cosf(rot.y), 0, 0, 0, 1, 0};
...
Matrix4x4 MatrixMultiply(Matrix4x4& m1, Matrix4x4& m2) {
	...
	result.m[3][0] = m1.m[3][0] * m2.m[0][1] + m1.m[3][1] * m2.m[1][1] + m1.m[3][2] * m2.m[2][1] + m1.m[3][3] * m2.m[3][1];
